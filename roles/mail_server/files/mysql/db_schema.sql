...
--
-- Host: localhost    Database: {{ postfix_db_name }}
-- ------------------------------------------------------
...
--
-- Table structure for table `alias2`
--

DROP TABLE IF EXISTS `alias2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `alias2` (
  `address` varchar(255) NOT NULL,
...
--
-- Table structure for table `mailbox_tmp`
--

DROP TABLE IF EXISTS `mailbox_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mailbox_tmp` (
  `username` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `name` varchar(255) CHARACTER SET utf8 NOT NULL,
  `maildir` varchar(255) NOT NULL,
...
-- Dump completed on 2016-05-11 15:40:13
